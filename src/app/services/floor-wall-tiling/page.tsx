...
export const metadata: Metadata = {
  title: "Floor & Wall Tiling UAE",
  description:
    "Professional floor and wall tiling works for residential and commercial properties in UAE by Al Asrar Al Thahabeya Technical Services.",
  keywords: [
    "Floor Tiling Dubai",
    "Wall Tiling Dubai",
    "Tiling Services Dubai",
    "Tile Installation Dubai",
    "Floor Tile Installation Dubai",
    "Wall Tile Installation Dubai",
  ],
  alternates: {
    canonical:
      "https://www.alasraralthahabeya.com/services/floor-wall-tiling",
  },
  openGraph: {
    title: "Floor & Wall Tiling UAE | Al Asrar Al Thahabeya",
    description:
      "Professional floor and wall tiling services in UAE.",
    url: "https://www.alasraralthahabeya.com/services/floor-wall-tiling",
...
const services = [
  ...
  "Residential Tiling Works",
  "Commercial Tiling Works",
...
const serviceSchema = {
  ...
  serviceType: "Floor & Wall Tiling Works",
  provider: {
    "@type": "LocalBusiness",
...
export default function FloorWallTilingPage() {
  return (
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div>
              ...
              <p className="mt-7 max-w-2xl text-base leading-8 text-white/60 sm:text-lg">
                Professional floor and wall tiling works for
                residential and commercial properties in UAE,
                with attention to finish, alignment and overall
                installation quality.
              </p>

              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <a
                  href="https://wa.me/971505847430?text=Hello%20Al%20Asrar%20Al%20Thahabeya%20Technical%20Services%2C%20I%20would%20like%20to%20request%20floor%20or%20wall%20tiling%20service%20in%20Dubai."
                  target="_blank"
            ...
            <div className="relative min-h-[380px] overflow-hidden border border-white/10 bg-[#101010]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative grid h-44 w-44 grid-cols-2 grid-rows-2 border border-[#9B111E]/40">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 sm:px-10 lg:grid-cols-[0.8fr_1.2fr] lg:px-12 lg:py-28">
          ...
          <div className="max-w-3xl">
            <p className="text-base leading-8 text-white/60 sm:text-lg">
              ...
              floor and wall tiling works for properties across
              UAE. Our services cover tile installation,
              replacement and related tiling requirements.
            </p>

            <p className="mt-6 text-base leading-8 text-white/40">
              From residential spaces to commercial properties,
              we provide technical tiling services according to
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 lg:px-12 lg:py-28">
          <div className="mb-14 flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
            ...
            <p className="max-w-md text-sm leading-7 text-white/40">
              Professional tiling works for different areas and
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                [
                  ...
                  "Tiling works focused on alignment, finish and project requirements.",
                ],
                [
                  "03",
                  "UAE Based",
                ...
                [
                  ...
                  "Discuss your tiling requirements directly through WhatsApp or phone.",
                ],
            ...
            <div className="relative flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
              <div>
                ...
                <p className="mt-5 max-w-xl text-sm leading-7 text-white/40">
                  ...
                  for floor and wall tiling requirements in UAE.
                </p>
              </div>
