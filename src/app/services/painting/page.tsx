...
export const metadata: Metadata = {
  title: "Painting Contracting UAE",
  description:
    "Professional painting contracting services for residential and commercial properties in UAE by Al Asrar Al Thahabeya Technical Services.",
  keywords: [
    "Painting Dubai",
    "Painting Services Dubai",
    "Painting Contractor Dubai",
    "Painting Contracting Dubai",
  ...
  alternates: {
    canonical:
      "https://www.alasraralthahabeya.com/services/painting",
  },
  openGraph: {
    title:
      "Painting Contracting UAE | Al Asrar Al Thahabeya",
    description:
      "Professional painting contracting services for residential and commercial properties in UAE.",
    url: "https://www.alasraralthahabeya.com/services/painting",
...
const serviceSchema = {
  ...
  serviceType: "Painting Contracting",
  provider: {
    "@type": "LocalBusiness",
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div>
              ...
              <p className="mt-7 max-w-2xl text-base leading-8 text-white/60 sm:text-lg">
                Professional painting contracting services for
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <a
                  href="https://wa.me/971505847430?text=Hello%20Al%20Asrar%20Al%20Thahabeya%20Technical%20Services%2C%20I%20would%20like%20to%20request%20painting%20service%20in%20Dubai."
                  target="_blank"
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 sm:px-10 lg:grid-cols-[0.8fr_1.2fr] lg:px-12 lg:py-28">
          ...
          <div className="max-w-3xl">
            <p className="text-base leading-8 text-white/60 sm:text-lg">
              ...
              Our services cover interior, exterior and related
              painting requirements.
            </p>

            <p className="mt-6 text-base leading-8 text-white/40">
              From individual rooms to larger property
              requirements, painting works can be arranged
              according to the condition and requirements of
              each project.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 lg:px-12 lg:py-28">
          <div className="mb-14 flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
            ...
            <p className="max-w-md text-sm leading-7 text-white/40">
              Painting solutions for residential and commercial
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                [
                  ...
                  "Structured painting services for residential and commercial properties.",
                ],
                [
                  "02",
                  "Detailed Preparation",
                  "Painting works arranged according to the condition and requirements of the property.",
                ],
                [
                  "03",
                  "UAE Based",
                ...
                [
                  ...
                  "Discuss your painting requirements directly through WhatsApp or phone.",
                ],
            ...
            <div className="relative flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
              <div>
                ...
                <p className="mt-5 max-w-xl text-sm leading-7 text-white/40">
                  ...
                  for residential and commercial painting
                  requirements in UAE.
                </p>
              </div>
