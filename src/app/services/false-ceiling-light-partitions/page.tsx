...
export const metadata: Metadata = {
  title: "False Ceiling & Light Partitions UAE",
  description:
    "Professional false ceiling and light partitions installation services for residential and commercial properties in UAE by Al Asrar Al Thahabeya Technical Services.",
  keywords: [
    "False Ceiling Dubai",
    "False Ceiling Installation Dubai",
    "Light Partitions Dubai",
    "Partition Installation Dubai",
    "Ceiling Works Dubai",
    "Gypsum Ceiling Dubai",
    "Gypsum Partitions Dubai",
  ],
  alternates: {
    canonical:
      "https://www.alasraralthahabeya.com/services/false-ceiling-light-partitions",
  },
  openGraph: {
    title:
      "False Ceiling & Light Partitions UAE | Al Asrar Al Thahabeya",
    description:
      "Professional false ceiling and light partition installation services in UAE.",
    url: "https://www.alasraralthahabeya.com/services/false-ceiling-light-partitions",
...
const serviceSchema = {
  ...
  serviceType: "False Ceiling & Light Partitions Installation",
  provider: {
    "@type": "LocalBusiness",
...
export default function FalseCeilingLightPartitionsPage() {
  return (
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <div>
              ...
              <p className="mt-7 max-w-2xl text-base leading-8 text-white/60 sm:text-lg">
                Professional false ceiling and light partition
                installation services for residential and
                commercial properties in UAE.
              </p>

              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <a
                  href="https://wa.me/971505847430?text=Hello%20Al%20Asrar%20Al%20Thahabeya%20Technical%20Services%2C%20I%20would%20like%20to%20request%20false%20ceiling%20or%20light%20partition%20service%20in%20Dubai."
                  target="_blank"
            ...
            <div className="relative min-h-[380px] overflow-hidden border border-white/10 bg-[#101010]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative h-44 w-52 border border-[#9B111E]/40">
                  <div className="absolute inset-x-0 top-1/2 h-px bg-white/10" />

                  <div className="absolute left-1/2 top-0 h-full w-px bg-white/10" />

                  <div className="absolute left-6 top-6 h-10 w-20 border border-white/10" />

                  <div className="absolute bottom-6 right-6 h-10 w-20 border border-white/10" />
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 sm:px-10 lg:grid-cols-[0.8fr_1.2fr] lg:px-12 lg:py-28">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#c88991]">
              Ceiling & Partition Services in UAE
            </p>
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-base leading-8 text-white/40">
              Our services cover ceiling installation, gypsum
              works, light partitions, repairs and modifications
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 lg:px-12 lg:py-28">
          <div className="mb-14 flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
            ...
            <p className="max-w-md text-sm leading-7 text-white/40">
              ...
              ceilings and light partition requirements.
            </p>
          </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                [
                  ...
                  "Ceiling and partition works focused on clean installation and project requirements.",
                ],
                [
                  "03",
                  "UAE Based",
                ...
                [
                  ...
                  "Discuss your ceiling or partition requirements directly through WhatsApp or phone.",
                ],
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 lg:px-12 lg:py-28">
          <div className="relative overflow-hidden border border-white/10 bg-[#101010] p-8 sm:p-12 lg:p-16">
            ...
            <div className="relative flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#c88991]">
                  Need Ceiling or Partition Service?
                </p>
                ...
                <p className="mt-5 max-w-xl text-sm leading-7 text-white/40">
                  ...
                  for false ceiling and light partition requirements
                  in UAE.
                </p>
              </div>
