...
export const metadata: Metadata = {
  title: "Carpentry & Wood Flooring Dubai",
  description:
    "Professional carpentry and wood flooring works for residential and commercial properties in UAE by Al Asrar Al Thahabeya Technical Services.",
  keywords: [
    "Carpentry Dubai",
    "Carpentry Services Dubai",
    "Wood Flooring Dubai",
    "Wood Flooring Installation Dubai",
    "Carpenter Dubai",
    "Woodwork Dubai",
  ...
  alternates: {
    canonical:
      "https://www.alasraralthahabeya.com/services/carpentry-wood-flooring",
  },
  openGraph: {
    title:
      "Carpentry & Wood Flooring UAE | Al Asrar Al Thahabeya",
    description:
      "Professional carpentry and wood flooring services in UAE.",
    url: "https://www.alasraralthahabeya.com/services/carpentry-wood-flooring",
...
const services = [
  ...
  "Doors & Wooden Fixtures",
  "Carpentry Repair & Maintenance",
];
...
const serviceSchema = {
  ...
  serviceType: "Carpentry & Wood Flooring Works",
  provider: {
    "@type": "LocalBusiness",
...
export default function CarpentryWoodFlooringPage() {
  return (
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <p className="mt-7 max-w-2xl text-base leading-8 text-white/60 sm:text-lg">
                Professional carpentry and wood flooring works
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <a
                  href="https://wa.me/971505847430?text=Hello%20Al%20Asrar%20Al%20Thahabeya%20Technical%20Services%2C%20I%20would%20like%20to%20request%20carpentry%20or%20wood%20flooring%20service%20in%20Dubai."
                  target="_blank"
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 sm:px-10 lg:grid-cols-[0.8fr_1.2fr] lg:px-12 lg:py-28">
          ...
          <div className="max-w-3xl">
            <p className="text-base leading-8 text-white/60 sm:text-lg">
              ...
              professional carpentry and wood flooring works for
              residential and commercial properties in UAE.
            </p>

            <p className="mt-6 text-base leading-8 text-white/40">
              Our services cover general carpentry, custom
              woodwork, wood flooring installation, repairs and
              related wooden fixtures and maintenance requirements.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10 lg:px-12 lg:py-28">
          <div className="mb-14 flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
            ...
            <p className="max-w-md text-sm leading-7 text-white/40">
              Woodwork and flooring solutions for different
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                [
                  ...
                  "Structured carpentry and wood flooring services for residential and commercial properties.",
                ],
                [
                  "02",
                  "Detailed Woodwork",
                  "Installation, repair and maintenance according to the requirements of each project.",
                ],
                [
                  "03",
                  "UAE Based",
                ...
                [
                  ...
                  "Discuss your carpentry or flooring requirements directly through WhatsApp or phone.",
                ],
            ...
            <div className="relative flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
              <div>
                ...
                <p className="mt-5 max-w-xl text-sm leading-7 text-white/40">
                  ...
                  for carpentry and wood flooring requirements in
                  UAE.
                </p>
              </div>
